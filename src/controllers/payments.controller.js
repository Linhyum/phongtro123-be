...
class PaymentsController {
   async payments(req, res) {
      ...
      if (typePayment === "MOMO") {
         ...
         var redirectUrl = "https://phongtro123-be.onrender.com/api/check-payment-momo"; // 8080
         var ipnUrl = "https://phongtro123-be.onrender.com/api/check-payment-momo";
      ...
      if (typePayment === "VNPAY") {
         ...
         const vnpayResponse = await vnpay.buildPaymentUrl({
            ...
            vnp_ReturnUrl: `https://phongtro123-be.onrender.com/api/check-payment-vnpay`, //
